...
IP Blacklist Cloud plugin allows you to blacklist IP addresses from visiting your WordPress website. Also, it submits your website link to the blocked IP database on [https://www.ip-finder.me](https://www.ip-finder.me/) which gives the other users to view how many sites have blocked the specific IP and see their comments.
New feature has been added to plugin which allows you to block usernames from spamming (comments) on your website.


Premium Software for managing multiple WordPress websites for synchronization: IP Blacklist Cloud Server - https://www.ip-finder.me/ipblc-server/


== Installation ==

Note: Before downloading and installing plugin, you must accept that plugin sends your website url (using site_url()), website name (using get_bloginfo(‘name’)) automatically when you blacklist any IP to https://www.ip-finder.me and show this on relative blacklisted IP. (Example: https://www.ip-finder.me/wpip?IP=203.81.202.127)
...
Q1. What data does this plugin submits to https://www.ip-finder.me/
Ans: * This plugin submits your WordPress site url and site name.
     * Version 1.1 sends pending comment to https://www.ip-finder.me/ and find the same comment if it was posted on any other WordPress websites who have installed this plugin.
...
* Changed ip-finder.me requests from http:// to https://


= 4.01 =
* Check if hosting allows to send data to ip-finder.me
...
= 2.6 =
* Allow you to connect with IP Blacklist Cloud Server (Premium Software) https://www.ip-finder.me/ipblc-server/
...
* PREMIUM SERVICE option has been added on settings pages of IP Blacklist plugin. (See details at: https://www.ip-finder.me/cloudaccount/ )
...
= 1.1 =
* Find Spam Pecentage of any pending comment by posting details to https://www.ip-finder.me/
...
= 4.01 =
* Check if hosting allowed to send data to ip-finder.me
